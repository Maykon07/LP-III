...
//=====================================================================
    ...
    public boolean isAfter(Time outroHorario) {
        if (this.hora > outroHorario.hora) {
            return true;
        } else if (this.hora < outroHorario.hora) {
            return false;
        } else {
            // Hours are equal, compare minutes
            if (this.min > outroHorario.min) {
                return true;
            } else if (this.min < outroHorario.min) {
                return false;
            } else {
                // Minutes are equal, compare seconds
                return this.seg > outroHorario.seg;
            }
        }
    }

    public boolean isBefore(Time outroHorario) {
        if (this.hora < outroHorario.hora) {
            return true;
        } else if (this.hora > outroHorario.hora) {
            return false;
